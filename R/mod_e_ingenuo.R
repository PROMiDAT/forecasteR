  ...
  output$error_snaive <- renderUI({
    ...
    tryCatch({
      res <- div(
        ...
        infoBox(tr("mse", lg), rvmodelo$snai$error$MSE, NULL, 
                icon("warning"), "red", 6, fill = T),
        infoBox(tr("rmse", lg), rvmodelo$snai$error$RMSE, NULL, 
                icon("warning"), "yellow", 6, fill = T),
        infoBox(tr("pfa", lg), rvmodelo$snai$error$PFA, NULL, 
                icon("level-up"), "green", 6, fill = T),
        infoBox(tr("ptfa", lg), rvmodelo$snai$error$PTFA, NULL, 
